...
* **WordPress Homepage**: `https://myeow.42.fr`
* **Adminer Login**: `http://myeow.42.fr:600`
* **Static Page**: `http://myeow.42.fr:3000`
* **cAdvisor Metrics**: `http://myeow.42.fr:8080`

---

## Managing Credentials
All administrative passwords, database names, and user accounts are stored locally in the environment secrets file:
* **Environment variables file**: Located at `/home/myeow/Inception/srcs/.env` on the host machine.
* **Admin Credentials**:
